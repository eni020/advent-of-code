...
fun main() {
  ...
  val inputLines = File("2023/day5/input5.txt").readLines()
  ...
  while (idx < partTwoElements.size) {
    ...
    mappings.forEach { mapping ->
      ...
      if (hasMapping(source.first, offset, mapping) && !partTwoMap.containsKey(source.first)) {
        val unmapped = mapping.sourceRangeStart + mapping.rangeLenght
